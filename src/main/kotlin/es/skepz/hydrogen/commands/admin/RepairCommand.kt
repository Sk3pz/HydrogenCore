...
class RepairCommand(core: Hydrogen) : CoreCMD(core, "repair", "<red>/repair",
    ...
    override fun run() {
        ...
        if (item.itemMeta !is Damageable) {
            sendMessage(sender, "<red>This item cannot be repaired!")
            return;
        }
        ...
        meta.damage = 0
        item.itemMeta = meta
        sendMessage(sender, "<gray>Item repaired!")
    }
